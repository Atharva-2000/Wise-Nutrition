...
const CancelledOrdersModal = ({isVisible, handleOrderModalVisibility, orderId}) => {
   ...
   const table_headers = ["Product", "Subscription", "Category", "Ordered Oty", "Delivered Oty", "Amount"]
                ...
                <DialogContent dividers>
                    <div className={styles.modal_body}>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={6}>
                                <p><span style={{fontWeight: 600}}>Refund Amount : </span><span>{orderDetails.refund_amount}</span></p>
                            </Grid>
                        </Grid>
