...
const CompletedOrdersModal = ({isVisible, handleOrderModalVisibility, orderId}) => {
   ...
   const table_headers = ["Product", "Subscription", "Category", "Quantity", "Amount"]
                ...
                <DialogContent dividers>
                    <div className={styles.modal_body}>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={6}>
                                <p><span style={{fontWeight: 600}}>Delivery Completion Date : </span><span>{orderDetails.delivery_completion_date}</span></p>
                            </Grid>
                        </Grid>
                                ...
                                orderDetails.item_details ?(
                                    <Table>
                                            ...
                                            <TableBody>
                                                ...
                                                <TableCell sx={{fontWeight: 600, py:0}}>{calcSum('quantity')}</TableCell> 
